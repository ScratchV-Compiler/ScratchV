...
| 文档 | 读者 | 链接 |
|------|------|------|
| **完成目录** | 总入口（课题 13 + 全部路径） | [`topic13/README.md`](13-窥孔优化器-完成目录.md) |
| 本页 | 新手入门、动手练习 | 当前文件 |
| 设计文档 | 负责人、审查者 | [13-窥孔优化器-设计文档.md](13-窥孔优化器-设计文档.md) |
| 开发文档（AI） | Agent / 维护者 | [archive/topic13_asm_peephole_guide.md](../../archive/提案/topic13_asm_peephole_guide.md) |
...
- 相关课题: [课题5 — 汇编代码美化器](../05-汇编代码美化器/05-汇编代码美化器.md) | [课题14 — 常量加载合并优化](../14-常量加载合并/14-常量加载合并.md) | [课题18 — 指令调度](../18-指令调度器/18-指令调度器.md)
