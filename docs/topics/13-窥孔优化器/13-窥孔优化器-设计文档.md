...
- **课题完成目录（总入口）** → [`topic13/README.md`](13-窥孔优化器-完成目录.md)  
- **面向新手的课题教程** → [13-窥孔优化器.md](13-窥孔优化器.md)  
- **面向 AI Agent 的实现指南** → [archive/topic13_asm_peephole_guide.md](../../archive/提案/topic13_asm_peephole_guide.md)
...
> **课题 13 收尾完成。** 维护入口：[archive/topic13_asm_peephole_guide.md](../../archive/提案/topic13_asm_peephole_guide.md)
